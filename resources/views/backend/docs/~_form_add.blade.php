    ...
    <div class="row">
        <div class="col-sm-4">
            ...
            <div class="form-group<?php if($errors->has('docs.name.' . $number_form)): ?> has-error<?php endif; ?>">
                ...
                @endif
                <div class="col-sm-12">
                    <input class="form-control" type="text" name="docs[name][]" value="{{ old('docs.name.' . $number_form, isset($doc->name) ? $doc->name : '') }}">
        ...
        <div class="col-sm-4">
            ...
            <div class="form-group<?php if($errors->has('docs.description.' . $number_form)): ?> has-error<?php endif; ?>">
                ...
                @endif
                <div class="col-sm-12">
                    <input class="form-control" type="text" name="docs[description][]" value="{{ old('docs.description.' . $number_form, isset($doc->description) ? $doc->description : '') }}">
        ...
        <div class="col-sm-3">
            @if(isset($doc))
                ...
                <div class="form-group<?php if($errors->has('docs.path_to_doc.' . $number_form)): ?> has-error<?php endif; ?>">
                    <label class="col-xs-12" for="document">&nbsp;</label>
                    <div class="col-xs-12">
                        <input class="form-control" type="file" name="docs[path_to_doc][]" value="{{ $doc->path_to_doc }}"  />
                        @if($errors->has('docs.path_to_old_doc.' . $number_form))
                            <div class="help-block">{{ $errors->first('docs.path_to_old_doc.' . $number_form) }}</div>
                        @endif
                    </div>
                </div>

    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content block-content-narrow">
                ...
                <form class="form-horizontal push-10-t" action="/backend/roles/store" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />

                    <div class="form-group<?php if($errors->has('role_title')): ?> has-error<?php endif; ?>">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" name="role_title" value="{{ old('role_title') }}" placeholder="Введите название роли">
                    ...
                    <div class="form-group<?php if($errors->has('role_slug')): ?> has-error<?php endif; ?>">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" name="role_slug" value="{{ old('role_slug') }}" placeholder="Введите slug">

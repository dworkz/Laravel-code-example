        ...
        <div class="row items-push">
            <div class="col-sm-7">
                <h1 class="page-heading">
                    Служебные записки <small>добавление.</small>
                </h1>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content block-content-narrow">
                ...
                <form class="form-horizontal push-10-t" action="/backend/note/store" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group<?php if($errors->has('name')): ?> has-error<?php endif; ?>">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" name="name" value="{{ old('name') }}" placeholder="@lang('app.note_name_enter')">
                    ...
                    <div class="form-group<?php if($errors->has('description')): ?> has-error<?php endif; ?>">
                        <div class="col-sm-9">
                            <div class="form-material">
                                ...
                                <textarea class="form-control" name="description" rows="3" placeholder="Описание">{{ old('description') }}</textarea>
                    ...
                    @if(count(Request::old('product.name')) > 0)
                        @for ($i = 0; $i < count(Request::old('product.name')); $i++)

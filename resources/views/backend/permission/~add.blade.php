        ...
        <div class="row items-push">
            <div class="col-sm-7">
                <h1 class="page-heading">
                    Права доступа <small>добавление.</small>
                </h1>
            </div>

            <div class="col-sm-5 text-right hidden-xs">
                <ol class="breadcrumb push-10-t">
                    <li><a class="link-effect" href="/backend/permissions">Права доступа</a></li>
                    <li>Добавить</li>
                </ol>
            </div>
    ...
    <div class="content">
        ...
        <div class="block">
            ...
            <div class="block-content block-content-narrow">
                ...
                <form class="form-horizontal push-10-t" action="/backend/permissions/store" method="POST">
                    <input type="hidden" name="_token" value="{{ csrf_token() }}" />

                    <div class="form-group<?php if($errors->has('permission_title')): ?> has-error<?php endif; ?>">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" name="permission_title" value="{{ old('permission_title') }}" placeholder="Введите название">
                    ...
                    <div class="form-group<?php if($errors->has('permission_slug')): ?> has-error<?php endif; ?>">
                        <div class="col-sm-9">
                            <div class="form-material">
                                <input class="form-control" type="text" name="permission_slug" value="{{ old('permission_slug') }}" placeholder="Введите slug">
                                <label for="material-text">Slug</label>
                                @if($errors->has('permission_slug'))
                                    <div class="help-block">{{ $errors->first('permission_slug') }}</div>
                                @else
                                    <div class="help-block">Название набранное латиницей</div>
                                @endif
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="form-group<?php if($errors->has('permission_description')): ?> has-error<?php endif; ?>">
                        <div class="col-sm-9">
                            <div class="form-material">
                                ...
                                <textarea class="form-control" name="permission_description" rows="3" placeholder="Введите описание"></textarea>
